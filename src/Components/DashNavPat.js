     ...
     <>
        <div id = "d_nav">
            <ul>
                ...
                <li> <NavLink className= "dnavlink"  exact activeClassName= "d_active" to="/dbp/form">{props.val1}</NavLink></li>
                <li><NavLink className= "dnavlink"  exact activeClassName= "d_active" to="/dbp/inst">{props.val2}</NavLink>  </li>
